<template>
  <section id="create-instruction-guide" class="create-instruction-guide-section">
      <div class="container w-50">
        
        <div class="create-instruction-guide-section-inner">
          <div class="create-instruction-guide bg-dark py-2">
              <h1>Create Instruction Guide</h1><hr />
          </div>
...
import InstructionGuidesService from '@/services/InstructionGuideService'
...
export default {
  ...
  methods: {
    async create () {
      ...
      // Posts data
      try {
        await InstructionGuidesService.postInstructionGuides(this.instructionGuide)
